  ...
  return (
    ...
    >
      ...
      >
              ...
              >
                ...
                >
                  <Stack
                    ...
                    // border={'1px solid green'}
                  >
                    <Text fontSize={{ base: "xs",sm:'sm',md:'md', xl:"xl" }} textTransform="capitalize" letterSpacing={{base:'0.1em',md:"0.2em"}} color={{base:"yellow",md:'#00FFFF'}}>
                      {slide.miniDesc}
                    </Text>
                    <Heading fontSize={{ base: "l",sm:'l',md:'xl', xl: "6xl" }} >
                      {slide.label}
                    </Heading>
        ...
        <VStack justify="center" pos="absolute" bottom="42%"  left="46%" w="full">
          {Array.from({
            length: slidesCount,
          }).map((_, slide) => (
            <Box 
              ...
              bg={currentSlide === slide ? "white" : "grey"}
              rounded="50%"
